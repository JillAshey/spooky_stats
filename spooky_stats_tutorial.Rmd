...
This tutorial contains materials and code for our Halloween-themed lab meeting on basic data analysis and visualization in R. In this Rmd, we will: 

- Read in and look at data files 
- Assess data normality for ANOVA 
- Run ANOVA
- Run post-hoc tests
- Visualize data 
...
## Photosynthesis data analysis - try it yourself! 
